...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2019 a las 16:22:27
...
('fmedina550@gmail.com', 'Felipe Medina', '1998-10-05', '9993532144', 20000),
...
(2, 1, 'carrera por la vida', 9000, 2),
(3, 2, 'Carrera atlética 5k', 7, 1);
...
--
-- Volcado de datos para la tabla `convocatorias_infoevento`
--

INSERT INTO `convocatorias_infoevento` (`id_conv`, `lugar_conv`, `hora_conv`, `fecha_conv`) VALUES
(3, 'Explanada', '07:00:00', '2019-12-10');
...
--
-- Volcado de datos para la tabla `convocatorias_precio`
--

INSERT INTO `convocatorias_precio` (`id_conv`, `modalidad_cp`, `precio_cp`) VALUES
(3, 'Pico a pico', 150);
...
(2, 'Danone', '9993254070', 'Calle 64 N491 x 59 a y 59 f fracc, parque industrial, Centro, 97000 Mérida, Yuc.C 40 ', 'Siliva Santéz');
...
(2, 'diego@gmail.com', '2019-12-02', '08:59:21', 2),
(3, 'grego@gmail.com', '2019-12-02', '09:14:46', 1);
...
INSERT INTO `kits` (`id_conv`, `fecha_kits`, `lugar_kits`, `requisitos_kits`) VALUES
(3, '2019-12-08', 'Gran Plaza', 'Sin requerimientos');
...
('fmedina550@gmail.com', 'Felipe Medina', 'MO');
...
('diego@gmail.com', 'diegoosi'),
('ferguzman@gmail.com', '56789'),
('grego@gmail.com', 'gregof'),
('p4@gmial.com', '12343'),
('p5@gmail.com', '123124'),
...
--
-- Volcado de datos para la tabla `ramas_eventos`
--

INSERT INTO `ramas_eventos` (`id_conv`, `modalidad_re`, `categoria_re`, `edad_re`) VALUES
(3, 'Pico a pico', 'Master20', 20);
...
('diego@gmail.com', 'Diego E', '99990', 'M', '2000-12-07'),
('ferguzman@gmail.com', 'Fernanda G', '9999235153', 'F', '1997-04-14'),
('grego@gmail.com', 'Gregorio S', '9994507080', 'M', '1999-12-14'),
...
--
ALTER TABLE `convocatorias`
  MODIFY `id_conv` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `empresas`
--
ALTER TABLE `empresas`
  MODIFY `id_emp` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
